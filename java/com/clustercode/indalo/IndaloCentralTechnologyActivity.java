...
public class IndaloCentralTechnologyActivity extends AppCompatActivity {

    private TextView txtReason1, txtReason2, txtReason3;
    private LinearLayout llReason1, llReason2, llReason3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_indalo_central_technology);
    ...
    public void ll1Clicked(View v) {
        if (txtReason1.getVisibility() == View.VISIBLE) {
            Intent intent = new Intent(this, IndaloCentralTechnology1Activity.class);
            startActivity(intent);
        } else {
    ...
    public void ll2Clicked(View v) {
        if (txtReason2.getVisibility() == View.VISIBLE) {
            Intent intent = new Intent(this, IndaloCentralTechnology2Activity.class);
            startActivity(intent);
        } else {
    ...
    public void ll3Clicked(View v) {
        if (txtReason3.getVisibility() == View.VISIBLE) {
            Intent intent = new Intent(this, IndaloCentralTechnology3Activity.class);
            startActivity(intent);
        } else {
            modifyViews(llReason1, txtReason1, HIDE);
            modifyViews(llReason2, txtReason2, HIDE);
